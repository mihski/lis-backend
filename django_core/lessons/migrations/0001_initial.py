# Generated by Django 3.1.7 on 2022-08-05 02:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_block', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='blocks', to='lessons.lessonblock')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lesson', to='lessons.lessonblock')),
                ('laboratory', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lessons.laboratory')),
                ('quest', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lessons.quest')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField()),
                ('content', models.JSONField()),
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lessons.course')),
            ],
            options={
                'abstract': False,
            },
